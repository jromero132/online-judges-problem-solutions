...
// Submission link: https://codeforces.com/contest/1547/submission/122004365
...
void solve(){
    ...
    printl(abs(x1 - x2) + abs(y1 - y2) + ((x1 == x2 && x1 == x3 && min(y1, y2) < y3 && max(y1, y2) > y3) || (y1 == y2 && y1 == y3 && min(x1, x2) < x3 && max(x1, x2) > x3) ? 2 : 0));
}
